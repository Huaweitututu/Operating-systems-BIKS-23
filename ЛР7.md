...
**Мета роботи** полягала в отриманні практичних навичок роботи з командною оболонкою Bash та ознайомленні з базовими діями при створенні скриптових сценаріїв. У процесі виконано розробку Bash-скриптів для виведення системної інформації, моніторингу ресурсів і автоматизації задач, що дозволило поглибити розуміння роботи з терміналом і сценаріями в Linux.

**Матеріальне забезпечення** включало:
1. ЕОМ типу IBM PC.
2. ОС Windows із віртуальною машиною VirtualBox (Oracle).
3. ОС GNU/Linux (дистрибутив Ubuntu).
4. Сайт Cisco NetAcad (netacad.com) та його онлайн-курси з Linux.
